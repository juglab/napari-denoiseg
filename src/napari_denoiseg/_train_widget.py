...
from .utils import TBPlotWidget, FolderWidget
from .utils import two_layers_choice, percentage_slider
from .utils import UpdateType, ModelSaveMode
...
def train_worker(widget: TrainWidget, pretrained_model=None):
    ...
    from .utils import UpdateType, generate_config
    ...
    # create updater
    train_args, denoiseg_updater, tf_version = prepare_training(denoiseg_conf,
                                                                X_t,
                                                                Y_t,
                                                                X_v,
                                                                Y_v,
